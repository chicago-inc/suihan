...
static const Keyword keywords[] = {
    ...
    {"graphics_rule",   TOK_GRAPHICS_RULE},
    {"applies_to",      TOK_APPLIES_TO},
    {"foreground_vector", TOK_FOREGROUND_VECTOR},
    {"background_vector", TOK_BACKGROUND_VECTOR},
    {"min_contrast",    TOK_MIN_CONTRAST},
    {"failure_mode",    TOK_FAILURE_MODE},
    {"if",              TOK_IF},
    {"then",            TOK_THEN},
    {"else",            TOK_ELSE},
    {NULL, TOK_EOF}
